...
- Probably no other boxes affect you, but I like "Windows Explorer integrat -> Open Git Bash here" which I use often.
...
- I don't use a credential manager, but you can set one up on your own if you would like.
